...
async function get_response(url) {
  ...
  let response_body = void 0;
  let content_type = void 0;
  if (!response.ok) {
    return custom_error(
      504,
      "GATEWAY TIMEOUT"
      // Server couldn't reach another server in time
    );
  }
...
var init_response = __esm({
  "src/util/response.js"() {
    ...
    init_virtual_unenv_global_polyfill_clear_immediate();
    init_error();
    __name(get_response, "get_response");
  }
});

// src/util/nord.js
var nord_exports = {};
__export(nord_exports, {
  get_details_nord: () => get_details
});
async function get_details(ip_addr) {
  ...
  let response = await get_response2(base_url);
  return response;
}
var get_response2;
var init_nord = __esm({
  "src/util/nord.js"() {
    ...
    init_virtual_unenv_global_polyfill_set_immediate();
    init_virtual_unenv_global_polyfill_clear_immediate();
    ({ get_response: get_response2 } = (init_response(), __toCommonJS(response_exports)));
    __name(get_details, "get_details");
  }
});

// src/util/ipapi.js
var ipapi_exports = {};
__export(ipapi_exports, {
  get_details_ipapi: () => get_details2
});
async function get_details2(ip_addr) {
  const base_url = `https://ipapi.co/${ip_addr}/json/?key=6tfpqRLu069K1yVtQOH7tzuingBfeXg4YTbF6orN9CVu6ec9v4`;
  let response = await get_response3(base_url);
  return response;
}
var get_response3;
var init_ipapi = __esm({
  "src/util/ipapi.js"() {
    init_modules_watch_stub();
    init_virtual_unenv_global_polyfill_process();
    init_virtual_unenv_global_polyfill_performance();
    ...
    init_virtual_unenv_global_polyfill_set_immediate();
    init_virtual_unenv_global_polyfill_clear_immediate();
    ({ get_response: get_response3 } = (init_response(), __toCommonJS(response_exports)));
    __name(get_details2, "get_details");
  }
});

// src/util/ipinfo.js
var ipinfo_exports = {};
__export(ipinfo_exports, {
  get_details_ipinfo: () => get_details3
});
async function get_details3(ip_addr) {
  const base_url = `https://ipinfo.info/ip_api.php?ip=${ip_addr}`;
  return get_response4(base_url);
}
var get_response4;
var init_ipinfo = __esm({
  "src/util/ipinfo.js"() {
    init_modules_watch_stub();
    init_virtual_unenv_global_polyfill_process();
    init_virtual_unenv_global_polyfill_performance();
    ...
    init_virtual_unenv_global_polyfill_set_immediate();
    init_virtual_unenv_global_polyfill_clear_immediate();
    ({ get_response: get_response4 } = (init_response(), __toCommonJS(response_exports)));
    __name(get_details3, "get_details");
  }
});

// src/util/ifconfig.js
var ifconfig_exports = {};
__export(ifconfig_exports, {
  get_details_ifconfig: () => get_details4
});
async function get_details4() {
  let base_addr = "http://ifconfig.me/all.json";
  return get_response5(base_addr);
}
var get_response5;
var init_ifconfig = __esm({
  "src/util/ifconfig.js"() {
    init_modules_watch_stub();
    init_virtual_unenv_global_polyfill_process();
    init_virtual_unenv_global_polyfill_performance();
    ...
    init_virtual_unenv_global_polyfill_set_immediate();
    init_virtual_unenv_global_polyfill_clear_immediate();
    ({ get_response: get_response5 } = (init_response(), __toCommonJS(response_exports)));
    __name(get_details4, "get_details");
  }
});

// src/util/cloudflare.js
var cloudflare_exports = {};
__export(cloudflare_exports, {
  get_details_cloudflare: () => get_details5
});
function get_details5(request_cf) {
...
var init_cloudflare4 = __esm({
  "src/util/cloudflare.js"() {
    ...
    init_virtual_unenv_global_polyfill_set_immediate();
    init_virtual_unenv_global_polyfill_clear_immediate();
    __name(get_details5, "get_details");
  }
});

// .wrangler/tmp/bundle-uzya6i/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
init_virtual_unenv_global_polyfill_console();
...
// .wrangler/tmp/bundle-uzya6i/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_process();
init_virtual_unenv_global_polyfill_performance();
init_virtual_unenv_global_polyfill_console();
...
init_virtual_unenv_global_polyfill_set_immediate();
init_virtual_unenv_global_polyfill_clear_immediate();
var { custom_error: custom_error2 } = (init_error(), __toCommonJS(error_exports));
var { get_details_nord } = (init_nord(), __toCommonJS(nord_exports));
var { get_details_ipapi } = (init_ipapi(), __toCommonJS(ipapi_exports));
var { get_details_ipinfo } = (init_ipinfo(), __toCommonJS(ipinfo_exports));
var { get_details_ifconfig } = (init_ifconfig(), __toCommonJS(ifconfig_exports));
var { get_details_cloudflare } = (init_cloudflare4(), __toCommonJS(cloudflare_exports));
var ALLOWED_METHODS = ["GET", "OPTIONS"];
var src_default = {
  async fetch(request) {
    if (!ALLOWED_METHODS.includes(request.method)) {
      return custom_error2(
        405,
    ...
    switch (pathname) {
      ...
      case "/ifconfig":
        if (param_ip)
          return custom_error2(404, "CUSTOM IP NOT SUPPORTED FOR IFCONFIG");
        else
          return get_details_ifconfig();
      case "/cloudflare":
      case "/cf":
        if (param_ip)
          return custom_error2(404, "CUSTOM IP NOT SUPPORTED FOR CLOUDFLARE");
        else
